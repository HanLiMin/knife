 ...
 *         2017年5月24日
 */
public class IntTreeInterval implements IntInterval {
	/**
	 ...
	 */
	@Override
	public IntTreeInterval addOpen(int leftEnd, int rightEnd) {
	 ...
	 */
	@Override
	public IntTreeInterval addClose(int leftEnd, int rightEnd) {
	 ...
	 */
	@Override
	public IntTreeInterval addOpenClose(int leftEnd, int rightEnd) {
	 ...
	 */
	@Override
	public IntTreeInterval addCloseOpen(int leftEnd, int rightEnd) {
	...
	@Deprecated
	@Override
	public IntTreeInterval removeClose(int leftEnd, int rightEnd) {
	...
	@Deprecated
	@Override
	public IntTreeInterval removeOpenClose(int leftEnd, int rightEnd) {
		throw new UnsupportedOperationException();
	}
	/**
	 * UnsupportedOperation
	...
	@Deprecated
	@Override
	public IntTreeInterval removeOpen(int leftEnd, int rightEnd) {
		throw new UnsupportedOperationException();
	}
	/**
	 * UnsupportedOperation
	...
	@Deprecated
	@Override
	public IntTreeInterval removeCloseOpen(int leftEnd, int rightEnd) {
		throw new UnsupportedOperationException();
	}
	@Override
	public void clear() {
	...
	public int length() {
		if (mod) {
			...
			Iterator<IntervalEntity> iterator = entities.iterator();
			while (iterator.hasNext()) {
				IntTreeInterval.IntervalEntity intervalEntity = iterator.next();
	...
	private class IntervalEntity implements Comparable<IntervalEntity> {
		...
		private IntTreeInterval getOuterType() {
			return IntTreeInterval.this;
		}
		@Override
		public String toString() {
